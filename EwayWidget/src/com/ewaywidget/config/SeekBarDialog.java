...
public class SeekBarDialog extends DialogPreference implements Slider.OnValueChangedListener {
    ...
    private static final int DEFAULT_MAX_VALUE = 600;
    ...
    protected View onCreateDialogView() {
        ...
        View view = inflater2.inflate(R.layout.dialog_pref_gps, null);
        // Setup SeekBar
        mSeekBar = (Slider) view.findViewById(R.id.seek_bar_pref_gps);
        mSeekBar.setMax(mMaxValue - mMinValue);
        mSeekBar.setValue(mCurrentValue - mMinValue);
        mSeekBar.setOnValueChangedListener(this);
        // Setup text label for current value
        mValueText = (TextView) view.findViewById(R.id.summary_pref_gps);
        mValueText.setText(Integer.toString(mCurrentValue) + " sec");
